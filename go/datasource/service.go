...
func (p *DatasourcePluginImpl) GRPCServer(broker *GRPCBroker, s *grpc.Server) error {
	RegisterDatasourcePluginServer(s, &GRPCServer{p.Plugin})
	return nil
}

func (p *DatasourcePluginImpl) GRPCClient(ctx context.Context, broker *GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
